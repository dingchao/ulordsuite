...
import (
	...
	"github.com/ulordsuite/ulordutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    ulordutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() ulordutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value ulordutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = ulordutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = ulordutil.NewTxFromBytes(testSimpleCoinTxBytes)
