...
/*
This test file is part of the ulordutil package rather than than the
ulordutil_test package so it can bridge access to the internals to properly test
...
import (
	...
	"github.com/ulordsuite/ulordutil/bech32"
...
func TstAddressPubKey(serializedPubKey []byte, pubKeyFormat PubKeyFormat,
	...
	pubKey, _ := ulordec.ParsePubKey(serializedPubKey, ulordec.S256())
	return &AddressPubKey{
		pubKeyFormat: pubKeyFormat,
		pubKey:       (*ulordec.PublicKey)(pubKey),
		pubKeyHashID: netID,
	}
}
