...
func NewAddressPubKey(serializedPubKey []byte, net *chaincfg.Params) (*AddressPubKey, error) {
	pubKey, err := ulordec.ParsePubKey(serializedPubKey, ulordec.S256())
	if err != nil {
		return nil, err
	}

	// Set the format of the pubkey.  This probably should be returned
	// from ulordec, but do it here to avoid API churn.  We already know the
...
func (a *AddressPubKey) PubKey() *ulordec.PublicKey {
	return a.pubKey
}
