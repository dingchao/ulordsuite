...
reason, the ulord suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire ulord
...
One of the major design goals of all core ulord packages is to aim for complete
...
commits](https://github.com/ulordsuite/ulord/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into ulord.
...
Rejoice as you will now be listed as a [contributor](https://github.com/ulordsuite/ulord/graphs/contributors)!
...
[ISC license](https://github.com/ulordsuite/ulord/blob/master/LICENSE).  This is
the same license as all of the code in the ulord suite.
