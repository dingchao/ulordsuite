...
5. [How do I use bootstrap.dat with ulord?](#Importing)
...
### 5. How do I use bootstrap.dat with ulord?

ulord comes with a separate utility named `addblock` which can be used to import
...
1. Stop ulord if it is already running.  This is required since addblock needs to
   access the database used by ulord and it will be locked if ulord is using it.
