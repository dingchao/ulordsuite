...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*ulordutil.Block, error) {
	...
	blocks := make([]*ulordutil.Block, 0, 256)
	genesis := ulordutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
