...
// TestBtcdExtCmds tests all of the ulord extended commands marshal and unmarshal
...
func TestBtcdExtCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			unmarshalled: &ulordjson.DebugLevelCmd{
				LevelSpec: "trace",
			},
		},
		{
			name: "node",
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("node", ulordjson.NRemove, "1.1.1.1")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewNodeCmd("remove", "1.1.1.1", nil)
			},
		...
		},
		{
			name: "node",
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("node", ulordjson.NDisconnect, "1.1.1.1")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewNodeCmd("disconnect", "1.1.1.1", nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"node","params":["disconnect","1.1.1.1"],"id":1}`,
			unmarshalled: &ulordjson.NodeCmd{
				SubCmd: ulordjson.NDisconnect,
				Target: "1.1.1.1",
			},
		},
		{
			name: "node",
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("node", ulordjson.NConnect, "1.1.1.1", "perm")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewNodeCmd("connect", "1.1.1.1", ulordjson.String("perm"))
			},
		...
		},
		{
			name: "node",
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("node", ulordjson.NConnect, "1.1.1.1", "temp")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewNodeCmd("connect", "1.1.1.1", ulordjson.String("temp"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"node","params":["connect","1.1.1.1","temp"],"id":1}`,
			unmarshalled: &ulordjson.NodeCmd{
				SubCmd:        ulordjson.NConnect,
				Target:        "1.1.1.1",
				ConnectSubCmd: ulordjson.String("temp"),
			},
		},
		{
			name: "generate",
			...
			unmarshalled: &ulordjson.GenerateCmd{
				NumBlocks: 1,
			},
		},
		{
		...
		},
		{
			name: "getheaders",
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("getheaders", []string{}, "")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewGetHeadersCmd(
					[]string{},
					"",
				)
			},
			marshalled: `{"jsonrpc":"1.0","method":"getheaders","params":[[],""],"id":1}`,
			unmarshalled: &ulordjson.GetHeadersCmd{
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("getheaders", []string{"000000000000000001f1739002418e2f9a84c47a4fd2a0eb7a787a6b7dc12f16", "0000000000000000026f4b7f56eef057b32167eb5ad9ff62006f1807b7336d10"}, "000000000000000000ba33b33e1fad70b69e234fc24414dd47113bff38f523f7")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewGetHeadersCmd(
					[]string{
		...
		},
		{
			name: "version",
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("version")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewVersionCmd()
			},
			marshalled:   `{"jsonrpc":"1.0","method":"version","params":[],"id":1}`,
			unmarshalled: &ulordjson.VersionCmd{},
		},
	}
