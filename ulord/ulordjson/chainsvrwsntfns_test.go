...
func TestChainSvrWsNtfns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "blockconnected",
			newNtfn: func() (interface{}, error) {
				return ulordjson.NewCmd("blockconnected", "123", 100000, 123456789)
			},
			staticNtfn: func() interface{} {
				return ulordjson.NewBlockConnectedNtfn("123", 100000, 123456789)
			},
			marshalled: `{"jsonrpc":"1.0","method":"blockconnected","params":["123",100000,123456789],"id":null}`,
			unmarshalled: &ulordjson.BlockConnectedNtfn{
				Hash:   "123",
				Height: 100000,
				Time:   123456789,
			},
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return ulordjson.NewCmd("blockdisconnected", "123", 100000, 123456789)
			},
			staticNtfn: func() interface{} {
				return ulordjson.NewBlockDisconnectedNtfn("123", 100000, 123456789)
			},
			marshalled: `{"jsonrpc":"1.0","method":"blockdisconnected","params":["123",100000,123456789],"id":null}`,
			unmarshalled: &ulordjson.BlockDisconnectedNtfn{
				Hash:   "123",
				Height: 100000,
				Time:   123456789,
			},
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return ulordjson.NewCmd("filteredblockconnected", 100000, "header", []string{"tx0", "tx1"})
			},
			staticNtfn: func() interface{} {
				return ulordjson.NewFilteredBlockConnectedNtfn(100000, "header", []string{"tx0", "tx1"})
			},
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return ulordjson.NewCmd("filteredblockdisconnected", 100000, "header")
			},
			staticNtfn: func() interface{} {
				return ulordjson.NewFilteredBlockDisconnectedNtfn(100000, "header")
			},
		...
		},
		{
			name: "recvtx",
			newNtfn: func() (interface{}, error) {
				return ulordjson.NewCmd("recvtx", "001122", `{"height":100000,"hash":"123","index":0,"time":12345678}`)
			},
			staticNtfn: func() interface{} {
				blockDetails := ulordjson.BlockDetails{
					Height: 100000,
					Hash:   "123",
					Index:  0,
					Time:   12345678,
				}
				return ulordjson.NewRecvTxNtfn("001122", &blockDetails)
			},
		...
		},
		{
			name: "redeemingtx",
			newNtfn: func() (interface{}, error) {
				return ulordjson.NewCmd("redeemingtx", "001122", `{"height":100000,"hash":"123","index":0,"time":12345678}`)
			},
			staticNtfn: func() interface{} {
				blockDetails := ulordjson.BlockDetails{
					Height: 100000,
				...
				return ulordjson.NewRedeemingTxNtfn("001122", &blockDetails)
			},
		...
		},
		{
			name: "rescanfinished",
			newNtfn: func() (interface{}, error) {
				return ulordjson.NewCmd("rescanfinished", "123", 100000, 12345678)
			},
			staticNtfn: func() interface{} {
				return ulordjson.NewRescanFinishedNtfn("123", 100000, 12345678)
			},
			marshalled: `{"jsonrpc":"1.0","method":"rescanfinished","params":["123",100000,12345678],"id":null}`,
			unmarshalled: &ulordjson.RescanFinishedNtfn{
				Hash:   "123",
				Height: 100000,
				Time:   12345678,
			},
		},
		{
			name: "rescanprogress",
			newNtfn: func() (interface{}, error) {
				return ulordjson.NewCmd("rescanprogress", "123", 100000, 12345678)
			},
			staticNtfn: func() interface{} {
				return ulordjson.NewRescanProgressNtfn("123", 100000, 12345678)
			},
			marshalled: `{"jsonrpc":"1.0","method":"rescanprogress","params":["123",100000,12345678],"id":null}`,
			unmarshalled: &ulordjson.RescanProgressNtfn{
				Hash:   "123",
				Height: 100000,
				Time:   12345678,
			},
		},
		{
			...
			unmarshalled: &ulordjson.TxAcceptedNtfn{
				TxID:   "123",
				Amount: 1.5,
			},
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return ulordjson.NewCmd("txacceptedverbose", `{"hex":"001122","txid":"123","version":1,"locktime":4294967295,"vin":null,"vout":null,"confirmations":0}`)
			},
			staticNtfn: func() interface{} {
				txResult := ulordjson.TxRawResult{
					Hex:           "001122",
					Txid:          "123",
					Version:       1,
					LockTime:      4294967295,
				...
				return ulordjson.NewTxAcceptedVerboseNtfn(txResult)
			},
			...
			unmarshalled: &ulordjson.TxAcceptedVerboseNtfn{
				RawTx: ulordjson.TxRawResult{
					Hex:           "001122",
					Txid:          "123",
					Version:       1,
					LockTime:      4294967295,
		...
		},
		{
			...
			unmarshalled: &ulordjson.RelevantTxAcceptedNtfn{
				Transaction: "001122",
			},
		},
	}
	...
	for i, test := range tests {
		...
		marshalled, err := ulordjson.MarshalCmd(nil, test.staticNtfn())
		if err != nil {
		...
		// notifications.
		marshalled, err = ulordjson.MarshalCmd(nil, cmd)
		if err != nil {
			t.Errorf("MarshalCmd #%d (%s) unexpected error: %v", i,
				test.name, err)
			continue
