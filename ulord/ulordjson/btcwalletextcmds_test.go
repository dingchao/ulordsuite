...
func TestBtcWalletExtCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			unmarshalled: &ulordjson.CreateNewAccountCmd{
				Account: "acct",
			},
		},
		{
			name: "dumpwallet",
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("dumpwallet", "filename")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewDumpWalletCmd("filename")
			},
			marshalled: `{"jsonrpc":"1.0","method":"dumpwallet","params":["filename"],"id":1}`,
			unmarshalled: &ulordjson.DumpWalletCmd{
				Filename: "filename",
			},
		},
		{
			name: "importaddress",
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("importaddress", "1Address", "")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewImportAddressCmd("1Address", "", nil)
			},
		...
		},
		{
			name: "importwallet",
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("importwallet", "filename")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewImportWalletCmd("filename")
			},
			marshalled: `{"jsonrpc":"1.0","method":"importwallet","params":["filename"],"id":1}`,
			unmarshalled: &ulordjson.ImportWalletCmd{
				Filename: "filename",
			},
		},
		{
			name: "renameaccount",
			newCmd: func() (interface{}, error) {
				return ulordjson.NewCmd("renameaccount", "oldacct", "newacct")
			},
			staticCmd: func() interface{} {
				return ulordjson.NewRenameAccountCmd("oldacct", "newacct")
			},
