...
var MainNetParams = Params{
	...
	DefaultPort: "9888",
	DNSSeeds: []DNSSeed{
		{"seed1.ulord.one", true},
		{"seed2.ulord.one", true},
		{"seed3.ulord.one", true},
	},
	...
	// Checkpoints ordered from oldest to newest.
	Checkpoints: []Checkpoint{
		//{0, newHashFromStr("0x0000079b37c3c290dc81e95bca28aa7df5636145ae35ebee86e10cc3cce96fb2")},
	...
	// Address encoding magics
	PubKeyHashAddrID:        68,//0x00, // starts with 1
	ScriptHashAddrID:        63,//0x05, // starts with 3
	PrivateKeyID:            0x80, // starts with 5 (uncompressed) or K (compressed)
	WitnessPubKeyHashAddrID: 0x06, // starts with p2
	WitnessScriptHashAddrID: 0x0A, // starts with 7Xh

	// BIP32 hierarchical deterministic extended key magics
	HDPrivateKeyID: [4]byte{0x04, 0x88, 0xad, 0xe4},//[4]byte{0x04, 0x88, 0xad, 0xe4}, // starts with xprv
	HDPublicKeyID:  [4]byte{0x04, 0x88, 0xb2, 0x1e},//[4]byte{0x04, 0x88, 0xb2, 0x1e}, // starts with xpub
