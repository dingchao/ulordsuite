...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ulordsuite/ulord/peer)
...
```bash
$ go get -u github.com/ulordsuite/ulord/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/ulordsuite/ulord/peer#example-package--NewOutboundPeer)  
