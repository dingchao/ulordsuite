...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ulordsuite/ulord/wire)
=======
...
[here](https://blog.conformal.com/btcwire-the-bitcoin-wire-protocol-package-from-ulord/).
...
```bash
$ go get -u github.com/ulordsuite/ulord/wire
```
