...
/*
ulord is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means ulord will work 'out of
...
parsed when ulord starts up.  By default, the configuration file is located at
~/.ulord/ulord.conf on POSIX-style operating systems and %LOCALAPPDATA%\ulord\ulord.conf
