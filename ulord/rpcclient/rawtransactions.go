...
func (r FutureGetRawTransactionResult) Receive() (*ulordutil.Tx, error) {
	...
	return ulordutil.NewTx(&msgTx), nil
}
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*ulordutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*ulordjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult ulordjson.TxRawResult
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*ulordjson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*ulordjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := ulordjson.NewDecodeRawTransactionCmd(txHex)
	return c.sendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*ulordjson.TxRawResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []ulordjson.TransactionInput,
	amounts map[ulordutil.Address]ulordutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToBTC()
	}
	cmd := ulordjson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime)
	return c.sendCmd(cmd)
}

// CreateRawTransaction returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawTransaction(inputs []ulordjson.TransactionInput,
	amounts map[ulordutil.Address]ulordutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	cmd := ulordjson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	return c.sendCmd(cmd)
}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult ulordjson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := ulordjson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []ulordjson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := ulordjson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.sendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []ulordjson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := ulordjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []ulordjson.RawTxInput, privKeysWIF []string,
	...
	cmd := ulordjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		ulordjson.String(string(hashType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) SearchRawTransactionsAsync(address ulordutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
	addr := address.EncodeAddress()
	verbose := ulordjson.Int(0)
	cmd := ulordjson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactions(address ulordutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
// Receive waits for the response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*ulordjson.SearchRawTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*ulordjson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address ulordutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address ulordutil.Address, skip,
	count int, includePrevOut, reverse bool, filterAddrs []string) ([]*ulordjson.SearchRawTransactionsResult, error) {
...
func (r FutureDecodeScriptResult) Receive() (*ulordjson.DecodeScriptResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var decodeScriptResult ulordjson.DecodeScriptResult
...
func (c *Client) DecodeScriptAsync(serializedScript []byte) FutureDecodeScriptResult {
	...
	cmd := ulordjson.NewDecodeScriptCmd(scriptHex)
	return c.sendCmd(cmd)
}

// DecodeScript returns information about a script given its serialized bytes.
func (c *Client) DecodeScript(serializedScript []byte) (*ulordjson.DecodeScriptResult, error) {
