...
func (c *Client) AddNodeAsync(host string, command AddNodeCommand) FutureAddNodeResult {
	cmd := ulordjson.NewAddNodeCmd(host, ulordjson.AddNodeSubCmd(command))
...
func (c *Client) NodeAsync(command ulordjson.NodeSubCmd, host string,
	connectSubCmd *string) FutureNodeResult {
	cmd := ulordjson.NewNodeCmd(command, host, connectSubCmd)
	return c.sendCmd(cmd)
}
...
func (c *Client) Node(command ulordjson.NodeSubCmd, host string,
...
func (r FutureGetAddedNodeInfoResult) Receive() ([]ulordjson.GetAddedNodeInfoResult, error) {
	...
	var nodeInfo []ulordjson.GetAddedNodeInfoResult
...
func (c *Client) GetAddedNodeInfoAsync(peer string) FutureGetAddedNodeInfoResult {
	cmd := ulordjson.NewGetAddedNodeInfoCmd(true, &peer)
	return c.sendCmd(cmd)
}
...
// peers.
func (c *Client) GetAddedNodeInfo(peer string) ([]ulordjson.GetAddedNodeInfoResult, error) {
...
func (c *Client) GetAddedNodeInfoNoDNSAsync(peer string) FutureGetAddedNodeInfoNoDNSResult {
	cmd := ulordjson.NewGetAddedNodeInfoCmd(false, &peer)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetConnectionCountAsync() FutureGetConnectionCountResult {
	cmd := ulordjson.NewGetConnectionCountCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetPeerInfoResult) Receive() ([]ulordjson.GetPeerInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetPeerInfoAsync() FutureGetPeerInfoResult {
	cmd := ulordjson.NewGetPeerInfoCmd()
	return c.sendCmd(cmd)
}

// GetPeerInfo returns data about each connected network peer.
func (c *Client) GetPeerInfo() ([]ulordjson.GetPeerInfoResult, error) {
...
// traffic statistics.
func (r FutureGetNetTotalsResult) Receive() (*ulordjson.GetNetTotalsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var totals ulordjson.GetNetTotalsResult
...
func (c *Client) GetNetTotalsAsync() FutureGetNetTotalsResult {
	cmd := ulordjson.NewGetNetTotalsCmd()
	return c.sendCmd(cmd)
}
