...
// easy generation of test blockchains.  The active ulord process is fully
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// Ensure ulord properly dispatches our registered call-back for each new
...
func (h *Harness) NewAddress() (ulordutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() ulordutil.Amount {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*ulordutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*ulordutil.Block, error) {
