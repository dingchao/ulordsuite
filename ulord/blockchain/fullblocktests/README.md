...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ulordsuite/ulord/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/ulordsuite/ulord/blockchain/fullblocktests
```
