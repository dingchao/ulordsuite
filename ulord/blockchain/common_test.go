...
// ulordutil.Block.  This is largely borrowed from the test code in ulordb.
func loadBlocks(filename string) (blocks []*ulordutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = ulordutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
