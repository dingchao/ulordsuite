...
func GetBlockWeight(blk *ulordutil.Block) int64 {
...
func GetTransactionWeight(tx *ulordutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *ulordutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
