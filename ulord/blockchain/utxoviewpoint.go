// Copyright (c) 2015-2016 The ulordsuite developers
...
func (view *UtxoViewpoint) AddTxOut(tx *ulordutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *ulordutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *ulordutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *ulordutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *ulordutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *ulordutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *ulordutil.Tx) (*UtxoViewpoint, error) {
