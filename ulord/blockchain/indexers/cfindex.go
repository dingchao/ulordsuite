...
import (
	...
	"github.com/ulordsuite/ulordutil/gcs"
	"github.com/ulordsuite/ulordutil/gcs/builder"
)
...
func storeFilter(dbTx database.Tx, block *ulordutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *ulordutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *ulordutil.Block,
