...
var (
	...
	defaultDataDir  = filepath.Join(ulordHomeDir, "data")
...
type config struct {
	DataDir        string `short:"b" long:"datadir" description:"Location of the ulord data directory"`
...
// time of writing, ulord currently places blocks for testnet version 3 in the
